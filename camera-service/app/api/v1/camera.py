...
@camera_router.post('/face-detect', response_class=FileResponse)
...
@camera_router.post('/start-streaming')
...
@camera_router.post('/stop-streaming')
...
@camera_router.get('/stream/{file}', response_class=FileResponse)
async def stream(
    file: str,
    token: str = ""
):
